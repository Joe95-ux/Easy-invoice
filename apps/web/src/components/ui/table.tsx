...
type TableProps = React.ComponentProps<"table"> & {
  ...
  /** Sticky column background. Use "background" on page surfaces; "card" inside Card. */
...
function Table({
  ...
  const stickyCol2Bg =
    surface === "background"
      ? "[&_th:nth-child(2)]:bg-background [&_td:nth-child(2)]:bg-background"
            ...
            cn(
              ...
              stickyColumns === 1 &&
                cn(
                  ...
                  "group-data-[table-scrolling]/table-container:[&_th:nth-child(1)]:border-r",
                  "group-data-[table-scrolling]/table-container:[&_td:nth-child(1)]:border-r",
                  "group-data-[table-scrolling]/table-container:[&_th:nth-child(1)]:border-border",
                  "group-data-[table-scrolling]/table-container:[&_td:nth-child(1)]:border-border",
                  "group-data-[table-scrolling]/table-container:[&_th:nth-child(1)]:shadow-[6px_0_14px_-4px_rgba(0,0,0,0.2)]",
                  "group-data-[table-scrolling]/table-container:[&_td:nth-child(1)]:shadow-[6px_0_14px_-4px_rgba(0,0,0,0.2)]",
                  "dark:group-data-[table-scrolling]/table-container:[&_th:nth-child(1)]:shadow-[6px_0_14px_-4px_rgba(0,0,0,0.65)]",
                  "dark:group-data-[table-scrolling]/table-container:[&_td:nth-child(1)]:shadow-[6px_0_14px_-4px_rgba(0,0,0,0.65)]",
                ),
            ),
          stickyColumns >= 2 &&
            cn(
              ...
              "group-data-[table-scrolling]/table-container:[&_td:nth-child(2)]:border-r",
